...
if(ENABLE_WHATSNEW AND TARGET OBS::browser-panels)
  ...
  elseif(OS_LINUX)
    ...
    target_link_libraries(obs-community-studio PRIVATE MbedTLS::mbedtls nlohmann_json::nlohmann_json OBS::blake2)
  ...
  target_enable_feature(obs-community-studio "What's New panel" WHATSNEW_ENABLED)
endif()
