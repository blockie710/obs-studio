if(SPARKLE_APPCAST_URL AND SPARKLE_PUBLIC_KEY)
  ...
  target_link_libraries(nexus-broadcast-studio PRIVATE "$<LINK_LIBRARY:FRAMEWORK,${SPARKLE}>")
  ...
  target_enable_feature(nexus-broadcast-studio "Sparkle updater" ENABLE_SPARKLE_UPDATER)

  include(cmake/feature-macos-update.cmake)
else()
  set(SPARKLE_UPDATE_INTERVAL 0) # Set anything that's not an empty integer
  target_disable_feature(nexus-broadcast-studio "Sparkle updater")
endif()