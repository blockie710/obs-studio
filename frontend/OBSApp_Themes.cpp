...
void OBSApp::FindThemes()
{
	...
	{
		const std::string themeDir = App()->userConfigLocation.u8string() + "/obs-community-studio/themes";
...
bool OBSApp::SetTheme(const QString &name)
{
	...
	string filename("obs-community-studio/themes/");
...
bool OBSApp::InitTheme()
{
	...
	char userDir[512];
	if (GetAppConfigPath(userDir, sizeof(userDir), "obs-community-studio/themes")) {
